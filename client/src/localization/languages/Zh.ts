...
export default {
  ...
  com_assistants_delete_actions_success: '已成功从助手删除动作',
  com_assistants_update_actions_success: '已成功创建或更新动作',
  com_assistants_update_actions_error: '创建或更新动作时出现错误。',
  com_assistants_delete_actions_error: '删除动作时出现错误。',
  com_assistants_actions_info: '让您的助手通过 API 检索信息或执行动作',
  ...
  com_assistants_actions_disabled: '您需要先创建助手，然后才能添加动作。',
  ...
  com_ui_delete_action: '删除动作',
  com_ui_delete_action_confirm: '您确定要删除此动作吗？',
  ...
  com_endpoint_agent_model: '智能体模型（推荐: GPT-3.5）',
  ...
  com_nav_welcome_assistant: '请选择一个助手',
  com_nav_welcome_agent: '请选择一个智能体',
