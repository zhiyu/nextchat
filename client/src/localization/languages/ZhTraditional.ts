...
export default {
  ...
  com_endpoint_agent_model: '智能體模型（建議：GPT-3.5）',
  ...
  com_ui_tools: '工具',
  com_assistants_actions: '動作',
  com_assistants_add_tools: '新增工具',
  com_assistants_add_actions: '新增動作',
  com_assistants_available_actions: '可用動作',
  ...
  com_assistants_delete_actions_success: '已成功刪除助理的動作',
  com_assistants_update_actions_success: '動作已成功建立或更新',
  com_assistants_update_actions_error: '更新或建立動作時發生錯誤。',
  com_assistants_delete_actions_error: '刪除動作時發生錯誤',
  com_assistants_actions_info: '讓您的助理透過 API 取得資訊或執行動作',
  ...
  com_show_agent_settings: '顯示智能體設定',
  ...
  com_agents_search_name: '依名稱搜尋智能體',
  com_agents_instructions_placeholder: '智能體程式使用的系統指令',
  com_agents_create_error: '建立您的智能體時發生錯誤。',
  com_agents_allow_editing: '允許其他使用者編輯您的助理',
  com_agents_update_error: '更新您的智能體時發生錯誤。',
  com_agents_not_available: '智能體不可用',
  com_agents_missing_provider_model: '請在建立智能體前選擇供應商和模型。',
  com_agents_enable_file_search: '啟用檔案搜尋',
  com_agents_file_search_disabled: '必須先建立智能體才能上傳檔案進行檔案搜尋。',
  ...
  com_agents_file_search_info:
    '啟用後，智能體將會被告知以下列出的確切檔案名稱，使其能夠從這些檔案中擷取相關內容。',
  ...
  com_ui_agent: '助理',
  com_ui_agents: '助理',
  com_ui_delete_agent_confirm: '您確定要刪除這個智能體嗎？',
  ...
  com_ui_delete_action_confirm: '您確定要刪除這個動作嗎？',
  ...
  com_ui_misc: '其他',
  com_nav_tool_dialog_agents: 'AI 智能體工具',
  com_ui_shop: '商店',
